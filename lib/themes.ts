...
export const THEMES: Record<ThemeChoice, ThemeConfig> = {
  ...
  flower: {
    ...
    bgOverlay: 'bg-gradient-to-br from-pink-300/80 via-rose-200/75 to-fuchsia-200/80',
  ...
  pastel: {
    ...
    bgOverlay: 'bg-gradient-to-br from-violet-200/80 via-purple-100/75 to-indigo-200/80',
  ...
  football: {
    ...
    bgOverlay: 'bg-gradient-to-b from-green-900/80 to-green-800/75',
